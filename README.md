...
The aim of this project is to create a classifier capaple of distinguishing between artists based on composition, colours, artstyle/-movement, brushwork and other visual characteristics.
...
--> Delete one folder, they contain the same images
--> Rename the other folder to Albrecht_Durer. The ü causes issues.
